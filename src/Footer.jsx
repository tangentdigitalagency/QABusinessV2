        ...
        return(
          ...
          <div className="container mx-auto px-4">
            ...
            <li className="mr-12 mb-2 md:mb-0"><a className="text-sm font-medium"  href="https://www.quantumassurance.com/terms-conditions" data-config-id="01_link3">Terms & Conditions</a></li>
                  ...
                  <a className="inline-block mr-auto lg:mr-0 py-4 px-8 text-sm text-white font-medium leafing-normal bg-blue-500 hover:bg-blue-300 hover:shadow-lg rounded"  href="tel:8552045980" data-config-id="primary-action">Get Your Free Quote</a>
                </div>
