...
class NavBar extends Component {
    ...
    <div className="flex justify-between items-center">
      ...
      <a className="inline-block px-6 py-2 text-sm text-white font-bold leading-loose bg-blue-400 hover:bg-blue-600 rounded transition duration-200" href="tel:8552045980" data-config-id="04_button">(855) 204-5980</a>
